...
#set_property PULLDOWN true [get_ports {JB[9]}]
...
#set_property -dict { PACKAGE_PIN A14 } [get_ports { XA_N[1] }]; #IO_L9N_T1_DQS_AD3N_15 Sch=xa_n[1]
#set_property -dict { PACKAGE_PIN A13 } [get_ports { XA_P[1] }]; #IO_L9P_T1_DQS_AD3P_15 Sch=xa_p[1]
...
set_property PACKAGE_PIN N16 [get_ports {COLOR_LED[2]}]
set_property PACKAGE_PIN R11 [get_ports {COLOR_LED[1]}]
set_property PACKAGE_PIN G14 [get_ports {COLOR_LED[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {COLOR_LED[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {COLOR_LED[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {COLOR_LED[0]}]
